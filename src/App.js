...
import {selectAll, read, unRead, trash, count, label, unLabel, checkMessage, starMessage} from './actions/index'
...
class App extends React.Component {
  render() {
    return (
      <div className="App">
        <Toolbar message={this.props.message}
...
const mapStateToProps = state => ({
  ...
  function matchDispatchToProps(dispatch){
      return bindActionCreators({selectAll: selectAll, read: read, unRead: unRead, trash: trash, count: count, label: label, checkMessage: checkMessage, starMessage, starMessage}, dispatch);
  }
